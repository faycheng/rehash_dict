...
int main(void)
{
    ...
    while (1)
    {
	    ...
	    add_dict(d, s3, 2, "12345678901234567890123456789012345678901234567890123456789012345678901234567890");
	    ...
	    add_dict(d, s5, 2, "12345678901234567890123456789012345678901234567890123456789012345678901234567890");
	    add_dict(d, s6, 2, "12345678901234567890123456789012345678901234567890123456789012345678901234567890");
	    if (fetch_dict_value(d, "key3", STRINGTYPE, value) == true)
	    {
		    printf("value:%s\n", value);
	    }
	    free(value);
	    value = NULL;
//	    if (replace_dict_value(d, "key3", STRINGTYPE, "hello redis dict") == true)
//	    {
